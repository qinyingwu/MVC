...
public class CarGUIView extends JFrame implements View{
   ...
   private void buildUpScrollGUI(){
	  ...
	  imgLabel.setMinimumSize(new Dimension(250, 400));
    ...
    public void update(){
       ...
       Image temp=imIcon.getImage().getScaledInstance(imgLabel.getWidth(), imgLabel.getHeight(), imIcon.getImage().SCALE_DEFAULT);
       imIcon=new ImageIcon(temp);
